...
class AprioriTest(unittest.TestCase):
    ...
    def test_return_items_with_min_support(self):
        ...
        result = returnItemsWithMinSupport(itemSet, transactionList, minSupport, freqSet)

        expected = set(
            [frozenset(["milk"]), frozenset(["apple"]), frozenset(["beer"]), frozenset(["rice"])]
        )
    ...
    def test_print_results_should_have_results_in_defined_format(self):
        with patch("sys.stdout", new=StringIO()) as fake_output:
            ...
            rules = [((("beer",), ("rice",)), 0.6666666666666666), ((("rice",), ("beer",)), 1.0)]
